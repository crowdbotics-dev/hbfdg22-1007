...
class UiconnectorViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_UI_CONNECTOR_PASSWORD
    USERNAME = settings.CONNECTOR_UI_CONNECTOR_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_UI_CONNECTOR"
